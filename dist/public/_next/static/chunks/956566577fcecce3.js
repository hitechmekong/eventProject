...
to {
  ...
  animation: ${B} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Z=({toast:e})=>{let{icon:t,type:r,iconTheme:a}=e;return void 0!==t?"string"==typeof t?s.createElement(W,null,t):t:"blank"===r?null:s.createElement(q,null,s.createElement(R,{...a}),"loading"!==r&&s.createElement(F,null,"error"===r?s.createElement(z,{...a}):s.createElement(H,{...a})))},K=b("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
